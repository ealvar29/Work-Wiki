...
- **Editor URL is `/ui/cms`** — case-insensitive, trailing slash optional (`/ui/cms` and `/ui/CMS/` both work; verified 2026-07-29). Deep links carry a fragment, e.g. `/ui/cms#context=epi.cms.contentdata:///13135`. **Not** `/Optimizely/CMS/`, `/EPiServer/CMS/`, or `/ui/` alone — those redirect to the site home instead of the editor, which reads exactly like a login failure and has cost debugging time more than once.
